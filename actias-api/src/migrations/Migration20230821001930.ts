...
export class Migration20230821001930 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "resources" add constraint "resources_project_id_foreign" foreign key ("project_id") references "projects" ("id") on update cascade on delete cascade;');
