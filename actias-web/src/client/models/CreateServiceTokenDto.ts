...
export type CreateServiceTokenDto = {
     ...
     */
    access?: Array<'SCRIPT_READ' | 'SCRIPT_WRITE' | 'SCRIPT_RESOURCE' | 'PERMISSIONS_READ' | 'PERMISSIONS_WRITE' | 'PERMISSIONS_RESOURCE' | 'KV_READ' | 'KV_WRITE' | 'KV_RESOURCE' | 'DATABASE_READ' | 'DATABASE_WRITE' | 'DATABASE_RESOURCE' | 'FULL'>;
    /**
