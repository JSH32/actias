...
export function defineTheme(monaco: {
  ...
  monaco.editor.defineTheme('actias-night', {
    ...
    colors: {
      ...
      'editorLineNumber.foreground': '#6b746e',
      'editorLineNumber.activeForeground': '#97a09a',
      'editor.lineHighlightBackground': '#171c1a',
      'editorCursor.foreground': '#a3e6b4',
      'editor.selectionBackground': '#2a322c',
      'editorWidget.background': '#0f1211',
      'editorWidget.border': '#2a322c',
