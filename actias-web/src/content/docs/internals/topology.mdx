...
<table>
  ...
  <tbody>
    ...
    <tr><td>store files</td><td>chunk or directory file hash to bytes</td><td>256 MB (<code>DIRECTORY_CACHE_MB</code>)</td><td>none, content-addressed; a restore fetches only the chunks it lacks</td></tr>
  </tbody>
</table>
