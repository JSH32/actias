...
<table>
  ...
  <tbody>
    <tr><td>the main file at a checkpoint, as the generation's base</td><td>the first flight of a residency, and each rotation; replicas receive it too</td></tr>
...
restores from the store and logs a durability incident. With two of
