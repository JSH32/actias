...
<table>
  ...
  <tbody>
    ...
    <tr><td>ack gate</td><td>10 s (<code>OBJECT_ACK_GATE_MS</code>) for a replica quorum or the store</td><td>a written call answers "outcome unknown"; the write keeps trying to ship</td></tr>
...
- [Event delivery](/docs/internals/objects/delivery): the fan-out mechanics.
- [Object placement](/docs/internals/objects/placement): homes, replicas, and
  recovery.
